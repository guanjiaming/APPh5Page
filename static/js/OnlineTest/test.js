    ...
    "exam": [
        {
            ...
            "values": [
                ...
                {
                    "type": 1,
                    "questionStem": "3.为保能在时效内完成送达，在抢单时需要参考下列哪些信息（ ）",
                    "options": [
                        "吃饭、看电视",
                        "取货距离、配送距离",
                        "去银行取钱",
        ...
        },
        {
            ...
            "values": [
                {
                    "type": 2,
                    "questionStem": "1.作为一个配送员的基本职能是什么？（ ）",
                    "options": [
                        "准时送达",
                        "保证配送货物完好",
                        "礼貌服务",
                ...
                {
                    "type": 2,
                    "questionStem": "2.通过审核及考试培训后，需要准备哪些？（ ）",
                    "options": [
                        "一部智能手机",
                        "交通工具，电动车/摩托车/汽车",
                        "一盆花",
                ...
                {
                    "type": 2,
                    "questionStem": "3.以下哪些行为属于一经发现账号永久停用？（ ）",
                    "options": [
                        "刷单行为",
                        "与客户发生争执、冲突等，导致重大投诉",
                        "私自拆、取、扣留货物",
